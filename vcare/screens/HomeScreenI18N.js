...
class HomeScreenI18N extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {};
    }
         ...
         return (
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}} >
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <TouchableOpacity onPress={() => this.setLanguage('vi')} style={{marginLeft: 20}}>
...
export default connect(mapStateToProps, mapDispatchToProps) (HomeScreenI18N);